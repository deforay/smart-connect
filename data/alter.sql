...
ALTER TABLE `dash_vl_request_form` ADD `tested_by` VARCHAR(500) NULL DEFAULT NULL AFTER `result_approved_datetime`;
ALTER TABLE `dash_eid_form` ADD `revised_by` VARCHAR(500) NULL DEFAULT NULL AFTER `result_approved_datetime`;
...
ALTER TABLE `dash_form_covid19` ADD `type_of_test_requested` VARCHAR(255) NULL DEFAULT NULL AFTER `reason_for_covid19_test`;
ALTER TABLE `dash_form_covid19` ADD `patient_city` VARCHAR(255) NULL DEFAULT NULL AFTER `patient_district`;
ALTER TABLE `dash_form_covid19` ADD `external_sample_code` VARCHAR(255) NULL DEFAULT NULL AFTER `sample_code`;
ALTER TABLE `dash_form_covid19` ADD `does_patient_smoke` VARCHAR(255) NULL DEFAULT NULL AFTER `patient_occupation`;
...
-- Amit 21-Jul-2022
ALTER TABLE `dash_eid_form` CHANGE `is_sample_rejected` `is_sample_rejected` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL;
...
-- Thana 27-Dec-2022
RENAME TABLE `dash_vl_request_form` TO `dash_form_vl`;
...
CREATE TABLE IF NOT EXISTS `dash_track_api_requests` (
  ...
  `api_url` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
