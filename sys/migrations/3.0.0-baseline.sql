...
ALTER TABLE `dash_form_eid` CHANGE `sample_code` `sample_code` VARCHAR(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL, CHANGE `remote_sample_code` `remote_sample_code` VARCHAR(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL;
...
-- Amit 21 Jul 2026
-- Toggle for the nightly rebuild of dash_form_*_current snapshot tables
-- (bin/console rebuild-snapshots, scheduled via crunz). OFF by default.
INSERT IGNORE INTO `dash_global_config` (`name`, `display_name`, `value`, `status`) VALUES
('daily_snapshot_rebuild', 'Rebuild dashboard snapshot (_current) tables daily?', 'no', 'active');
